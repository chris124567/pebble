...
const (
	compactionStartLine23_1 = `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [n5,pebble,s6] 1216510  [JOB 284925] compacting(default) L2 [442555] (4.2 M) + L3 [445853] (8.4 M)`
	compactionStartLine     = `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [n5,pebble,s6] 1216510  [JOB 284925] compacting(default) L2 [442555] (4.2MB) Score=1.01 + L3 [445853] (8.4MB) Score=0.99;  OverlappingRatio: Single 8.03, Multi 25.05;`

	compactionEndLine23_1 = `I211215 14:26:56.318543 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1886 ⋮ [n5,pebble,s6] 1216554  [JOB 284925] compacted(default) L2 [442555] (4.2 M) + L3 [445853] (8.4 M) -> L3 [445883 445887] (13 M), in 0.3s, output rate 42 M/s`
	compactionEndLine     = `I211215 14:26:56.318543 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1886 ⋮ [n5,pebble,s6] 1216554  [JOB 284925] compacted(default) L2 [442555] (4.2MB) Score=1.01 + L3 [445853] (8.4MB) Score=1.01 -> L3 [445883 445887] (13MB), in 0.3s, output rate 42MB/s`

	compactionMultiLevelStartLine = `I211215 14:26:56.318543 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1886 ⋮ [n5,pebble,s6] 1216554 [JOB 11] compacting(default) [multilevel] L2 [250858] (2.1MB) Score=1.09 + L3 [247985 247989 247848] (17MB) Score=0.99 + L4 [250817 250834 238396] (28MB) Score=1.00; OverlappingRatio: Single 3.77, Multi 1.46;`
	compactionMultiLevelEndline   = `I211215 14:26:56.318543 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1886 ⋮ [n5,pebble,s6] 1216554 [JOB 11] compacted(default) [multilevel] L2 [250858] (2.1MB) Score=1.09 + L3 [247985 247989 247848] (17MB) Score=0.99 + L4 [250817 250834 238396] (28MB) Score=1.00 -> L4 [250859 250860 250861 250862 250863] (46MB), in 0.2s (0.2s total), output rate 185MB/s`

	flushStartLine = `I211213 16:23:48.903751 21136 3@vendor/github.com/chris124567/pebble/event.go:599 ⋮ [n9,pebble,s8] 24 [JOB 10] flushing 2 memtables to L0`

	flushEndLine23_1 = `I211213 16:23:49.134464 21136 3@vendor/github.com/chris124567/pebble/event.go:603 ⋮ [n9,pebble,s8] 26 [JOB 10] flushed 2 memtables to L0 [1535806] (1.3 M), in 0.2s, output rate 5.8 M/s`
	flushEndLine     = `I211213 16:23:49.134464 21136 3@vendor/github.com/chris124567/pebble/event.go:603 ⋮ [n9,pebble,s8] 26 [JOB 10] flushed 2 memtables to L0 [1535806] (1.3MB), in 0.2s, output rate 5.8MB/s`
	...
	compactionStartNoNodeStoreLine23_1 = `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [n?,pebble,s?] 1216510  [JOB 284925] compacting(default) L2 [442555] (4.2 M) + L3 [445853] (8.4 M)`
	compactionStartNoNodeStoreLine     = `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [n?,pebble,s?] 1216510  [JOB 284925] compacting(default) L2 [442555] (4.2 M) + L3 [445853] (8.4MB)`
	flushStartNoNodeStoreLine          = `I211213 16:23:48.903751 21136 3@vendor/github.com/chris124567/pebble/event.go:599 ⋮ [n?,pebble,s?] 24 [JOB 10] flushing 2 memtables to L0`
...
func TestParseLogContext(t *testing.T) {
	testCases := []struct {
		...
		{
			line:      `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [n5,pebble,s6] foo`,
			timestamp: "211215 14:26:56.012382",
			node:      5,
			store:     6,
		},
		{
			line:      `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [T?,n5,pebble,s6] foo`,
			timestamp: "211215 14:26:56.012382",
			node:      5,
			store:     6,
		},
		{
			line:      `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [T15,n5,pebble,s6] foo`,
			timestamp: "211215 14:26:56.012382",
			node:      5,
			store:     6,
		},
		{
			line:      `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [T1,n?,pebble,s6] foo`,
			timestamp: "211215 14:26:56.012382",
			node:      -1,
			store:     6,
		},
		{
			line:      `I211215 14:26:56.012382 51831533 3@vendor/github.com/chris124567/pebble/compaction.go:1845 ⋮ [n5,pebble,s?] foo`,
			timestamp: "211215 14:26:56.012382",
			node:      5,
			store:     -1,
		},
